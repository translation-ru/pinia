...
Изначально Pinia не проходила через процесс RFC (Request for Comments). Я тестировал идеи, опираясь на свой опыт разработки приложений, изучал код других разработчиков, работу с клиентами, использующими Pinia, и ответы на вопросы в Discord.
